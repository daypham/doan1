...
<?php
  ...
  if(isset($_POST['themtin2'])){
    ...
    $hinhanh_tmp = $_FILES['hinhanh']['tmp_name'];
     $sql_insert_tinbsd = mysqli_query($con,"INSERT INTO tinbds(tieude,mattp,quanhuyen,phuong,duong,mota,hinhanh,magiaodich,iduser,madonvi,gia,dientich) values ('$tieude','$mattp','$quanhuyen','$phuong','$duong','$mota','$hinhanh','$magiaodich', '$iduser','$donvi', '$gia', '$dientich')");
...
?>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
             ...
             <?php 
            $sql_loaigiaodich = mysqli_query($con, 'SELECT  * FROM giaodich WHERE (magiaodich=6) ORDER BY magiaodich ASC');
        ?>
      ...
      <div style="margin-left:200px" class="col-md-8">
        ...
        <table class="table table-bordered ">
          ...
          <tr>
            ...
            <td><a href="?quanly=dangtinmua&xoa=<?php echo $row_tin['mabds'] ?>">Xóa</a> || <a href="xulytin.php?quanly=capnhat&capnhat_id=<?php echo $row_tin['mabds'] ?>">Cập nhật</a></td>
          </tr>
        <?php
          } 
          ?> 
